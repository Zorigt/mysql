...
create table a_vets.vt_staff (
  ...
  , stf_name_first  varchar(25)      null
  , stf_job_title   varchar(25)      null
...
create table a_vets.vt_animals(
  ...
  , constraint vt_animals_animal_types_fk foreign key (an_type) references vt_animal_types (an_type)
  , constraint vt_animals_clients_fk foreign key (cl_id)   references vt_clients (cl_id)
...
create table a_vets.vt_exam_headers(
  ...
  , constraint vt_exam_headers_animals_fk  foreign key (an_id) references vt_animals (an_id)
  , constraint vt_exam_headers_staff_fk foreign key (stf_id) references vt_staff (stf_id)
