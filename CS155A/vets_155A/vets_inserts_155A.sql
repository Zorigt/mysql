...
insert into vt_staff_pay (stf_id, stf_ssn, stf_salary, stf_hire_date)
  values (55,  '323438454', 37500,   '2009-09-26');

insert into vt_staff_pay (stf_id, stf_ssn, stf_salary, stf_hire_date)
  values (52,  '325778945', 20000,   '2008-08-12');  
...
insert into vt_clients (cl_id, cl_name_last, cl_name_first, cl_address, cl_city, cl_state, cl_postal_code, cl_phone)  
  values  (25479, 'Boston', 'Edger', 'POB 2', 'Boston', 'MA', 21555, null);  
...
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values(21005, 1825, 'Koshka', 'dormouse', '2011-03-06' );
...
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
 ...
 insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values(16003, 1825, 'Ursula', 'cat', '2006-06-06' );  
...
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values(11029, 4534, null, 'bird', '2005-10-01' );
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (1996, 16002, 29, '2012-11-16 9:15'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (1996, 1, 748, 29.50, 'rat ulcer recurrence'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (1997, 16002, 29, '2012-11-06 10:45'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (1997, 1, 748, 0.00, 'rat ulcer recurrence'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (1998, 17025, 29, '2012-11-07 10:45'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (1998, 1, 104, 30.00, 'routine exam'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (1998, 2, 687, 45.00, null  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (1998, 3, 1002, 25.00, 'parasite external'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (1999, 16002, 29, '2012-12-03 14:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (1999, 1, 524, 20.00, 'followup on parasites'  );    

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3010, 17026, 29, '2012-12-22 10:45'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3010, 1, 104, 25.00, 'routine exam'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3001, 17027, 29, '2012-12-24 10:45'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3001, 1, 104, 25.00, 'routine exam'  );
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3101, 15001, 15, '2013-01-02 13:00' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3101, 1, 104, 60, 'reg exam' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3101, 2, 615, 75.00, 'poss infection' );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3102, 15002, 15, '2013-01-02 13:00' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3102,  1, 104, 60, 'reg exam' );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3103, 16002, 38, '2013-01-02 15:30' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3103, 1, 4601, 275, 'aggressive behaviour' );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3104, 12035, 38, '2013-01-02 16:30' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3104, 1, 106, 75, 'moult' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3104, 2, 613, 47, null );    
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3202, 17025, 29, '2013-02-03 14:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3202, 1, 341, 20.00, 'followup on parasites'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3203, 16002, 29,  '2013-02-03 14:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3203, 1, 524, 20.00, 'followup on parasites'  );
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3288, 15001, 25, '2013-02-09 09:00' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3288, 1, 104, 30, 'check up'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3288, 2, 1002, 25, null  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3288, 3, 687, 45, 'shell softening'  );    

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3282, 21001, 15, '2013-02-23 10:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3282, 1, 523, 60, 'yearly checkup'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3282, 2, 110, 50, null  );    
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3304, 17027, 15, '2013-03-06 10:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3304, 1, 341, 25, 'yearly checkup'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3304, 2, 1003, 25, null  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3306, 17025, 29, '2013-03-06 10:45'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3306, 1, 104, 30.00, 'routine exam'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3306, 2, 687, 45.00, null  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3306, 3, 1002, 25.00, 'parasite external'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (2007, 17026, 29, '2013-03-21 10:45'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (2007, 1, 104, 25.00, 'routine exam'  );
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3390, 19845, 15, '2013-03-22 09:00' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3390, 1, 105, 55, 'yearly checkup'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3390, 2, 101, 50, null  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3392, 21003, 15, '2013-03-26 09:30' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3392, 1, 398,30, 'weight loss follow up '  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3392, 2, 400, 21, null   );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3392, 3, 1003, 45, 'retest for parasites'    );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3393, 16002, 29, '2013-03-23 12:15'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3393, 1, 748, 29.50, 'rat ulcer recurrence'  );    

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3409, 17027, 29, '2013-03-27 10:45'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3409, 1, 104, 25.00, 'routine exam'  );
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3486, 21005, 15, '2013-03-31 13:00' );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3486, 1, 4601, 275, 'aggressive behaviour' );
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3420, 16003, 15, '2013-04-01 16:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3420, 1, 108, 80.00, 'yearly checkup'  );
 
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3494, 15001, 25, '2013-04-22 09:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3494, 1, 104, 30, 'follow up check up'  ); 
 
 insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3411, 17025, 29, '2013-04-29 14:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3411, 1, 341, 20.00, 'followup on parasites'  );

 insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3412, 17025, 29, '2013-04-30 14:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3412, 1, 341, 20.00, 'followup on parasites'  );
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3413, 16003, 15, '2013-05-01 16:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3413, 1, 308, 5.00, 'follow up check up'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3612, 16003, 15, '2013-05-23 08:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3513, 15401, 15, '2013-06-06 10:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3513, 1, 104, 30.00, 'yearly checkup'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3513, 2, 110, 75.00, null  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3514, 15002, 29, '2013-06-10 10:45'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3514, 1, 104, 30.00, 'routine exam'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3514, 2, 1002, 15.00, null  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3514, 3, 1003, 25.00, 'parasite screen'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3552, 16003, 15, '2013-06-10 10:30'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
